...
public class cmdWarpRename extends AbstractCommand {
    ...
    public void execute(String[] args, Player player) {
        ...
        // TODO: ÷ffentliche Warps kˆnnen nicht umbennent werden auﬂer von Admins
        ...
        // INFORM PLAYER
        PlayerUtils.sendSuccess(player, pluginName, "Der Warp '" + oldName + "' heiﬂt nun '" + warp.getName() + "'!");

        // PUBLIC WARPS - INFORM EVERYONE
        if (warp.isPublic())
            Bukkit.broadcastMessage("Der Warp '" + oldName + "' heiﬂt nun '" + warp.getName() + "'!");
